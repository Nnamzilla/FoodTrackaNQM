...
import XCTest
@testable import FoodTrackerNQM

class FoodTrackerNQMTests: XCTestCase {

    //MARK: Meal Class Tests
    
    // Confirm that the Meal initializer returns a Meal opbject when passed valid paramaters.
